...
| ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Git Presentation](https://youtu.be/zeC5iwsHllk) ([slides](https://docs.google.com/presentation/d/1onRsF-5NQbky8BOac5cGsJunjBisvauQPEC4hOWPaGI/edit#slide=id.p))                     | Learn basic git commands needed for collaboration and version control.                                                                                   | - [Conventional commits](https://www.conventionalcommits.org/en/v1.0.0/) <br /> - [CodeWhisperer CLI tool](https://aws.amazon.com/codewhisperer/): to help autocomplete CLI commands. Can also return commands based on a description of what you want to do. <br/> - [Oh Shit Git](https://ohshitgit.com/) <br/> - [Git Flight Rules](https://github.com/k88hudson/git-flight-rules) |
| [Code Review Presentation](https://youtu.be/QcItLjFJ_Us) ([slides](https://docs.google.com/presentation/d/1GP_X91rd3W50GN6FjcLfAge8SD0O45qe7qdtHPO_D2I/edit?pli=1#slide=id.p))       | Learn how to complete an effective code review on a teammate's pull request.                                                                             | - [Conventional comments](https://conventionalcomments.org/) <br/> - [Github extension for VSCode](https://marketplace.visualstudio.com/items?itemName=GitHub.vscode-pull-request-github)                                                                                                                                                                                             |
...
| 🤝 Developer pairings | 🖥 Assigned Github issue                                                                                                                                                                                                                                                                                                                                                                                   |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Devina                | [15. Firebase refactoring](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/35) <br/>[17. As a user, I want to navigate to the list page automatically after seslecting a list](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/38) <br/>[24. Create Tailwind Theme and Fonts for our site](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/52) |
| Andrea                | [16. As a user, I want a list item to uncheck itself after 24 hours from being check as purchased](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/36) <br/> [23. Install react-icons](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/49)                                                                                                                         |
| Emily                 | [18. As a user, I want a streamlined experience adding a new item to the list](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/39) <br/> [21. Install Tailwind](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/42)                                                                                                                                                |
| Shane                 | [19. As a user, I want to be able to delete a list](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/40)                                                                                                                                                                                                                                                                                |
...
| 👋 Sync meetings                                  | Agenda                                                                                     |
| ------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| [Final Weekly Sync](https://youtu.be/lEBWIw74z4s) | - Demo <br> - [Retro](https://github.com/orgs/the-collab-lab/projects/218) <br> - Planning |
| Optional                                          | Office Hours                                                                               |

| 🤝 Developer pairings | 🖥 Assigned Github issue                                                                                                                                                                                        |
| --------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Devina & Shane        | [26. Home Page Styling](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/56) and [27. Header and Navigation Styling](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/57) |
| Andrea & Emily        | [28. List Styling](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/58) and [29. Manage List Styling](https://github.com/the-collab-lab/tcl-68-smart-shopping-list/issues/59)                |

| 📖 Self-study learning modules | Description                                                                                                                                                                                                      |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Job-Fit Mock Interview         | We will be using [Interviewable](https://app.interviewable.io/login) to practice responding to common interview questions. Check your email for login details, or reach out on Slack if you're unable to access. |
...
| 📖 Self-study learning modules | Description                                                                                                                                                                                                      |
| ------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Technical Mock Interview       | We will be using [Interviewable](https://app.interviewable.io/login) to practice responding to common interview questions. Check your email for login details, or reach out on Slack if you're unable to access. |
